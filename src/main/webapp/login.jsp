	...
	<p class="heading" >Welcome To MyTutor</p>
		<div class="form-box">
			...
			<div class="inp"><h3> ${error}</h3></div>
				...
				<div class="inp">
					<img src="images/password.png"><input  name="pass" type="password" id="password" class="input-field" placeholder="Password" style="width: 88%; border: none;" required="required">
				</div>
			...
			<div class="other" id="other">
				...
				<button class="connect" onclick="google()">
					<img src="images/google.png"><span><h5>Sign in</h5></span>
				</button>
			</div>
